...
(function exposeChapterConfig(root, factory) {
  ...
  return Object.freeze([
    Object.freeze({ page: 'intro.html', title: '认识C程序', shortTitle: '认识C程序', demo: 6, quiz: 0 }),
    ...
    Object.freeze({ page: 'function.html', title: '函数', shortTitle: '函数', demo: 8, quiz: 6 }),
    Object.freeze({ page: 'array.html', title: '数组', shortTitle: '数组', demo: 15, quiz: 6 }),
    Object.freeze({ page: 'pointer.html', title: '指针', shortTitle: '指针', demo: 8, quiz: 6 }),
